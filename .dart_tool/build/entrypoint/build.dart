...
final _builders = <_i1.BuilderApplication>[
  ...
  _i1.apply(
      ...
      hideOutput: true,
      defaultGenerateFor:
          const _i4.InputSet(include: [r'$package$', r'test/**'])),
  ...
  _i1.applyPostProcess(r'angular:placeholder_cleanup', _i2.placeholderCleanup),
  _i1.applyPostProcess(
      r'angular:component_source_cleanup', _i2.componentSourceCleanup,
      defaultGenerateFor: const _i4.InputSet(include: [r'lib/**']),
