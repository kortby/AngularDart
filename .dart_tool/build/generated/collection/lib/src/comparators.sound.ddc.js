  ...
  equality._UnorderedEquality$ = dart.generic((E, T) => {
    ...
    class _UnorderedEquality extends core.Object {
      ...
      equals(elements1, elements2) {
        ...
        if (elements1 == elements2) return true;
        if (elements1 == null || elements2 == null) return false;
        let counts = __t$HashMapOfE$dynamic().new({equals: dart.bind(this[_elementEquality$], 'equals'), hashCode: dart.bind(this[_elementEquality$], 'hash'), isValidKey: dart.bind(this[_elementEquality$], 'isValidKey')});
        let length = 0;
